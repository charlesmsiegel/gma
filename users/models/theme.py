...
class Theme(models.Model):
    ...
    is_high_contrast = models.BooleanField(
        default=False,
        help_text="Whether this theme provides high contrast for accessibility",
    )
    supports_system_preference = models.BooleanField(
        default=True,
    ...
    @classmethod
    def get_accessibility_themes(cls):
...
class UserThemePreference(models.Model):
    ...
    # User preferences
    auto_switch_dark_mode = models.BooleanField(
        default=False,
        help_text="Automatically switch between light/dark themes based on system preference",
    )
    preferred_light_theme = models.ForeignKey(
        Theme,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
    ...
    preferred_dark_theme = models.ForeignKey(
        Theme,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
    ...
    def get_theme_for_mode(self, is_dark=False):
