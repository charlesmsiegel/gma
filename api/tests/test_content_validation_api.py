...
class ContentValidationAPITest(TestCase):
    ...
    def test_validate_content_against_single_user(self):
        ...
        response = self.client.post(self.validate_for_user_url, content_data, format='json')
    ...
    def test_validate_content_for_entire_campaign(self):
        ...
        content_data = {
            "content": "This scene involves violence against animals and mental health issues.",
            "campaign_id": self.campaign.id
        }
        
        response = self.client.post(self.validate_for_campaign_url, content_data, format='json')
    ...
    def test_content_validation_with_consent_required(self):
        ...
        content_data = {
            "content": "Scene with character death and violence",  # Triggers veils for player1
            "user_id": self.player1.id,
            "campaign_id": self.campaign.id
        }
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertTrue(response.data['consent_required'])  # player1 has consent_required=True
    ...
    def test_batch_content_validation(self):
        ...
        batch_data = {
            ...
            "content_items": [
                {
                    "id": "scene1",
                    "content": "Safe tavern conversation"
                },
                {
                    "id": "scene2", 
                    "content": "Combat with violence and torture"
                },
                {
                    "id": "scene3",
                    "content": "Animal harm scenario"
                }
            ]
        }
        
        response = self.client.post(
            reverse("api:validate_content_batch"),
            batch_data,
            format='json'
        )
...
class ContentValidationAPIErrorHandlingTest(TestCase):
    ...
    def test_missing_required_fields(self):
        ...
        response = self.client.post(self.validate_for_user_url, incomplete_data, format='json')
    ...
    def test_invalid_data_types(self):
        ...
        response = self.client.post(self.validate_for_user_url, invalid_data, format='json')
...
class ContentValidationAPIPerformanceTest(TestCase):
    ...
    def test_validate_content_for_large_campaign(self):
        ...
        content_data = {
            "content": "This is a test scene with some content that might trigger safety concerns.",
            "campaign_id": self.campaign.id
        }
        ...
        self.assertEqual(len(response.data['user_results']), 20)
